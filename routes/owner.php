...
use App\Http\Controllers\Owner\MeterController;
...
Route::group(['prefix' => 'owner', 'as' => 'owner.', 'middleware' => ['auth', 'owner']], function () {
    ...
    Route::group(['prefix' => 'property', 'as' => 'property.'], function () {
        ...
        Route::post('images/reorder', [PropertyController::class, 'reorderImages'])->name('images.reorder');
    });
    ...
    Route::group(['prefix' => 'meter', 'as' => 'meter.'], function () {
        Route::get('meter-list', [MeterController::class, 'index'])->name('list');
        Route::post('store',[MeterController::class,'store'])->name('store');
        Route::get('all',[MeterController::class,'getAll'])->name('all');
        Route::get('delete/{id}',[MeterController::class,'delete'])->name('delete');
        Route::get('details/{id}',[MeterController::class,'details'])->name('details');
        Route::post('update',[MeterController::class,'update'])->name('update');
    });
