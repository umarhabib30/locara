                                                ...
                                                <div class="plan-usage-list">
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        ...
                                                        <h4 class="flex-grow-1 ms-1">
                                                            ...
                                                            {{ $userPlan->max_property }} {{ __('Properties') }}
                                                        </h4>
                                                    </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        ...
                                                        <h4 class="flex-grow-1 ms-1">
                                                            ...
                                                            {{ $userPlan->max_maintainer == -1 ? __('Unlimited') : $userPlan->max_maintainer }}
                                                            {{ __('Maintainers') }}
                                                        </h4>
                                                    </div>
                                                    {{-- <div class="d-flex mb-2">
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        ...
                                                        <h4 class="flex-grow-1 ms-1">
                                                            ...
                                                            {{ $userPlan->max_invoice == -1 ? __('Unlimited') : $userPlan->max_invoice }}
                                                            {{ __('Invoices') }}
                                                        </h4>
                                                    </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        ...
                                                        <h4 class="flex-grow-1 ms-1">
                                                            ...
                                                            {{ $userPlan->max_auto_invoice == -1 ? __('Unlimited') : $userPlan->max_auto_invoice }}
                                                            {{ __('Auto Invoices') }}
                                                        </h4>
                                                    </div>
