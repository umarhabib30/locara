...
@section('content')
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="property-details-right text-xl-end">
                                                            <button type="button" class="theme-btn" id="add"
                                                                    title="{{ __('Add Blog Category') }}">{{ __('Add Blog Category') }}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="tbl-action-btns d-inline-flex">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('admin.blogs.categories.destroy', [$data->id]) }}"
                                                                            method="post"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addModalLabel">{{ __('Add Blog Category') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                            class="iconify" data-icon="akar-icons:cross"></span></button>
                </div>
                <form class="ajax" action="{{ route('admin.blogs.categories.store') }}" method="POST" data-handler="getShowMessage">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="editModalLabel">{{ __('Edit Blog Category') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                            class="iconify" data-icon="akar-icons:cross"></span></button>
                </div>
                <form class="ajax" action="{{ route('admin.blogs.categories.store') }}" method="POST"
    ...
    <input type="hidden" id="getInfoRoute" value="{{ route('admin.blogs.categories.get.info') }}">
@endsection
...
@push('script')
    ...
    <script src="{{ asset('assets/js/custom/blog-categories.js') }}"></script>
@endpush
