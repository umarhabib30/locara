        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="invoice-preview-wrap">
                    <div class="invoice-heading-part" style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="invoice-heading-left" style="flex-grow: 1; text-align: center;">
                        ...
                        <div class="invoice-heading-right" style="flex-shrink: 0; text-align: right;">
                            <div class="status-btn status-btn-green invoiceStatus" id="invoiceStatusPaid">{{ __('Paid') }}</div>
                            <div class="invoice-heading-right-status-btn invoiceStatus" id="invoiceStatusPending">{{ __('Pending') }}</div>
                            <div class="status-btn status-btn-red mx-1 invoiceStatus" id="invoiceStatusOverdue">{{ __('Over Due') }}</div>
                        </div>
                    ...
                    <div class="invoice-address-part">
                        ...
                        <h4 class="invoice-generate-title">{{ __('Pay To') }}</h4>
                            <div class="invoice-address">
                                <h5 class="OwnerPrintName"></h5>
                                <h5 >{{Auth::user()->email}}</h5>
                                <h5 class="OwnerPrintAddress"></h5>
                                <h5 class="OwnerPrintTaxNumber"></h5>
                        ...
                        <div class="invoice-address-part-right">
                            ...
                            <div class="invoice-address">
                                ...
                                <div class="d-flex">
                                    ...
                                    <small class="unitName" style="margin-top: 10px !important;"></small>
                                </div>
                                <div class="d-flex">
                                    <h6 class="propertZipCode"></h6>
                                    <h6 class="propertCityId" style="margin-left: 5px !important;"></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="invoice-table-part">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="invoice-tbl-last-field invoice-heading-color">{{ __('Tax Rate') }}
                                        </th>
                                        {{-- <th class="invoice-tbl-last-field invoice-heading-color">{{ __('Tax') }}
                                        </th> --}}
                                        <th class="invoice-tbl-last-field invoice-heading-color">{{ __('Sales Tax') }}
                                        </th>
                        ...
                        <div class="show-total-box">
                            <div class="invoice-tbl-last-field">{{ __('Late Fee') }}: <span class="invoice-heading-color late_fee"></span></div>
                            <div class="invoice-tbl-last-field">{{ __('Total') }}: <span class="invoice-heading-color total"></span></div>
                        </div>
                    </div>
