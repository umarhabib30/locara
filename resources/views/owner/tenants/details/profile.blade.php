                            ...
                            <div class="account-settings-rightside bg-off-white theme-border radius-4 p-25">
                                ...
                                <div class="tenants-profile-information">
                                    ...
                                    <div class="settings-inner-box bg-white theme-border radius-4 mb-25">
                                        ...
                                        <div class="account-settings-title border-bottom">
                                        ...
                                        <div class="account-settings-info-box p-20">
                                            ...
                                            <div class="row account-settings-info-item">
                                                ...
                                                <div class="col-md-6 col-lg-8 col-xl-8 col-xxl-10">
                                                    <p>{{ $tenant->date_of_birth }}</p>
                                                </div>
                                            </div>
                                            <div class="row account-settings-info-item">
                                                <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-2">
                                                    <p class="color-heading">{{ __('NID Number') }}:</p>
                                                </div>
                                                <div class="col-md-6 col-lg-8 col-xl-8 col-xxl-10">
                                                    <p>{{ $tenant->nid_number }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!-- Account Settings Content Box Start -->
                                <div class="account-settings-content-box bg-white theme-border radius-4 mb-25">
                                ...
                                <div class="account-settings-content-box bg-white theme-border radius-4 mb-25">
                                    ...
                                    <div class="account-settings-info-box p-20">
                                        <div class="row account-settings-info-item">
                                            ...
                                            <div class="col-md-6 col-lg-8 col-xl-8 col-xxl-10">
                                                <p>{{ $tenant->permanent_address }}, {{ $tenant->permanent_zip_code }} {{ $tenant->permanent_city_id }}, {{ $tenant->permanent_state_id }} {{ $tenant->permanent_country_id }}</p>
                                            </div>
                                        </div>
                                ...
                                <div class="account-settings-content-box bg-white theme-border radius-4 mb-25">
                                    ...
                                    <div class="account-settings-info-box p-20">
                                        ...
                                        <div class="row account-settings-info-item">
                                            <div class="col-md-6 col-lg-4 col-xl-4 col-xxl-2">
                                                <p class="color-heading">{{ __('Pet Type') }}:</p>
                                            </div>
                                            <div class="col-md-6 col-lg-8 col-xl-8 col-xxl-10">
                                                <p>{{ __($tenant->pets) }}</p>
                                            </div>
